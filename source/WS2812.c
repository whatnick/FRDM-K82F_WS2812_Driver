...
#define	FLEXIO_ISR_IOPORT		GPIOE
...
#define	WAITING_LOOP_IOPORT		GPIOE
#define	WAITING_LOOP_PIN		21

// WS2812B timing setup based on the 8 MHz FLEXIO0 clock (IRC)
...
// WS2812B bit rate = 1/10 FLEXIO0 clock
...
// - enables the 8 MHz IRC as the FLEXIO0 clock source
// - performs FLEXIO0 initialization common for all 3 control modes
...
// the routine sets up parameters for the FLEXIO0 isr (triggered by ret code only)
